...
public class TestRemoteJVM_EJB {
		...
		public static void main(String[] args)
		{
			try {
				...
				AuthenticationRemote auth  = (AuthenticationRemote) ctx.lookup("StateLessEJBProject/SessionEJBFile/remote-com.bank.authentication.AuthenticationRemote");
				
				auth.authenticate("amit", "saxena");
